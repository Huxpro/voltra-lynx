...
export function TimerScreen() {
        ...
        renderVoltraVariantToJson(
          ...
          >
            <Voltra.VStack spacing={8} alignment="center">
              <Voltra.Text style={{ color: '#aaa', fontSize: 14 } as any}>
                Voltra Timer
              </Voltra.Text>
              <Voltra.Timer
                style={
  ...
  return (
    ...
    >
      ...
      <text
        style={
          { fontSize: 14, color: '#CBD5F5', marginBottom: 24 } as any
        }
      >
      ...
      >
        ...
        >
          <text
            style={
              { color: '#fff', fontSize: 16, linearWeight: 1 } as any
            }
          >
            Mode
          </text>
        ...
        {/* Duration stepper (only for timer mode) */}
        {mode === 'timer' && (
          <view
            style={{
              display: 'linear',
          ...
          >
            ...
            <view
              ...
              style={{
                ...
                paddingBottom: 6,
                backgroundColor:
                  textStyle === 'relative' ? '#3B82F6' : '#334155',
                borderRadius: '6px',
              }}
            >
              <text
