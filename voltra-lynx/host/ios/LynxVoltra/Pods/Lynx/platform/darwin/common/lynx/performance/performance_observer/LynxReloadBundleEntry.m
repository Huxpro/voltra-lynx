...
- (instancetype)initWithDictionary:(NSDictionary*)dictionary {
    ...
    if (self) {
        self.reloadBundleStart = [LynxPerformanceEntryConverter getNumberObject:dictionary name:@"reloadBundleStart" defaultValue:@(-1)];
        self.reloadBundleEnd = [LynxPerformanceEntryConverter getNumberObject:dictionary name:@"reloadBundleEnd" defaultValue:@(-1)];
        self.reloadBackgroundStart = [LynxPerformanceEntryConverter getNumberObject:dictionary name:@"reloadBackgroundStart" defaultValue:@(-1)];
        self.reloadBackgroundEnd = [LynxPerformanceEntryConverter getNumberObject:dictionary name:@"reloadBackgroundEnd" defaultValue:@(-1)];
