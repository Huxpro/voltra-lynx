...
std::string AutoGenCSSDecoder::ToFontOpticalSizingType(
    FontOpticalSizingType type) {
  switch (type) {
    case FontOpticalSizingType::kNone:
      return "none";
    case FontOpticalSizingType::kAuto:
      return "auto";
  }
}

std::string AutoGenCSSDecoder::ToXPlaceholderFontWeightType(
    XPlaceholderFontWeightType type) {
  switch (type) {
    case XPlaceholderFontWeightType::kNormal:
      return "normal";
    case XPlaceholderFontWeightType::kBold:
      return "bold";
    case XPlaceholderFontWeightType::k100:
      return "100";
    case XPlaceholderFontWeightType::k200:
      return "200";
    case XPlaceholderFontWeightType::k300:
      return "300";
    case XPlaceholderFontWeightType::k400:
      return "400";
    case XPlaceholderFontWeightType::k500:
      return "500";
    case XPlaceholderFontWeightType::k600:
      return "600";
    case XPlaceholderFontWeightType::k700:
      return "700";
    case XPlaceholderFontWeightType::k800:
      return "800";
    case XPlaceholderFontWeightType::k900:
      return "900";
  }
}

std::string AutoGenCSSDecoder::ToXPlaceholderFontStyleType(
    XPlaceholderFontStyleType type) {
  switch (type) {
    case XPlaceholderFontStyleType::kNormal:
      return "normal";
    case XPlaceholderFontStyleType::kItalic:
      return "italic";
    case XPlaceholderFontStyleType::kOblique:
      return "oblique";
  }
}

std::string AutoGenCSSDecoder::ToPointerEventsType(PointerEventsType type) {
  switch (type) {
    case PointerEventsType::kAuto:
      return "auto";
    case PointerEventsType::kNone:
      return "none";
  }
}
